...
class AdminProductFormPage extends StatefulWidget {
  ...
  @override
  State<AdminProductFormPage> createState() => _State();
}
...
class _State extends State<AdminProductFormPage> {
  ...
  bool _isActive = true;
  List<String> _images = [];
  final String _tempId = 'prod_temp_${DateTime.now().millisecondsSinceEpoch}';
